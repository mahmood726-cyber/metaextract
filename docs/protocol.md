        # Metaextract: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metaextract.git

        ## Objective

        MetaExtract provides NLP-based extraction of effect sizes, confidence intervals, and study characteristics from published meta-analysis manuscripts.
        ...
        - Code: https://github.com/mahmood726-cyber/metaextract.git
        - Dashboard: https://mahmood726-cyber.github.io/metaextract/
