# E156 Protocol — `MetaExtract`

This repository is the source code and dashboard backing an E156 micro-paper on the [E156 Student Board](https://mahmood726-cyber.github.io/e156/students.html).

---

## `[92]` MetaExtract: Browser-Based Effect Estimate Extraction from Clinical Trial Abstracts via Deterministic Pattern Matching

**Type:** methods  |  ESTIMAND: Extraction sensitivity for HR, OR, RR (95% CI)  
...
Links:
  ...
  Protocol:  https://github.com/mahmood726-cyber/MetaExtract/blob/main/E156-PROTOCOL.md
